package com.d0pam1n.siplib.Model;
...
/**
 * Model for the account´s configuration data.
 *
...
public class SipAccount implements Parcelable {
    ...
    public static final Parcelable.Creator<SipAccount> CREATOR =
            new Parcelable.Creator<SipAccount>() {
                @Override
                public SipAccount createFromParcel(final Parcel in) {
                    return new SipAccount(in);
                }

                @Override
                public SipAccount[] newArray(final int size) {
                    return new SipAccount[size];
                }
            };
    ...
    public SipAccount setUsername(String username) {
    ...
    public SipAccount setPassword(String password) {
    ...
    public SipAccount setRealm(String realm) {
        this.realm = realm;
        return this;
    }
    ...
    public SipAccount setHost(String host) {
        this.host = host;
        return this;
    }
    ...
    public SipAccount setPort(long port) {
        this.port = port;
        return this;
    }
    ...
    public SipAccount setTcpTransport(boolean tcpTransport) {
    ...
    public SipAccount setAuthenticationType(String authenticationType) {
